...
# Lint as: python3
"""Custom formatting functions for M5-Walmart dataset.
...
class WalmartFormatter(data_formatters.base.GenericDataFormatter):
  ...
  """
    ...
    _column_definition = [
        ...
        # ('wday', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
        ...
        ("sell_price", DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
    ]
    ...
    """
        ...
        if valid_boundary is None:
            valid_boundary = pd.datetime(2015, 10, 19)
    ...
    def get_fixed_params(self):
        ...
        fixed_params = {
            ...
            "num_epochs": 12,  # change it back to 100   ### missing , ### restored  by philip
    ...
    def get_default_model_params(self):
        ...
        model_params = {
            "dropout_rate": 0.1,
            "hidden_layer_size": 240,  # change it back to 240
            "learning_rate": 0.001,
            "minibatch_size": 256,  # change it back to 128
